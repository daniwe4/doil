...
$c = buildContainerForApp($script_dir, $home_dir, $user_name, $github_run);
...
function buildContainerForApp(string $script_dir = "", string $home_dir = "", string $user_name = "", string $github_run  = "false") : Container
{
    $c = new Container();

    $c["install"] = function($c) use ($github_run, $script_dir) {
        return new Install(
            $c["logger"],
